...
Depending on the chosen environment, the conditions for being solved differ,
...
- ddpg_agent.py - the implementation of the agent.
- model.py - the neural network models using pyTorch.

You can run the **`Continuous_Control_final.ipynb`** script to execute the code yourself.
